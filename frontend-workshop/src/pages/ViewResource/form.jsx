...
const Form = () => {
    ...
    return (
        <form onSubmit={handleAdd} data-test-id ='resource-form'>
            <Card>
                <CardBody>
                    <Heading data-test-id = 'resource-form-header' textAlign={{base: 'center', md: 'flex-start'}}> {id === 'add' ? 'Add' : 'Update'} Resource </Heading>
                    <Stack>
                    ...
                    <CardFooter>
                        <HStack w = 'full' maxW = 'container.md' mx='auto' flexDirection = {{base:'column', md: 'row'}} alignItems={{base:'flex-start', md: 'center'}}>
                            {!isEditing && <>
                                <Button   
                            ...
                            <Spacer />
                            <ButtonGroup w = {[`full`, `full`, `fit-content`]} flex={{base: 'column', md: 'row'}}>
                                {isEditing && <>
                                    <Button data-test-id='resource-form-cancel'
                                            type = 'button' 
                                            onClick={handleCancel} w = {[`full`, `full`, `fit-content`]}>
                                        Cancel
                                    </Button>
                                    <Button data-test-id = 'resource-form-submit' colorScheme = 'green' type='submit' w = {[`full`, `full`, `fit-content`]}> 
